...
@Entity
public class Haribaskar_Children {
     @Id
     private int babyId;
     ...
     public Haribaskar_Children() {

     }

     public Haribaskar_Children(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
