...
@Entity
public class Haribaskar_Village {
    @Id
    ...
    public Haribaskar_Village(){}
    public Haribaskar_Village(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
