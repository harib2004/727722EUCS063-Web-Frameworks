...
@Entity
public class Haribaskar_Course {
     ...
     public Haribaskar_Course() {

     }

     public Haribaskar_Course(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
